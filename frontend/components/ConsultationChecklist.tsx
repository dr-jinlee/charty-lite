...
const STATIC_CHECKS = [
  // 상담 목적
  { id: 'complaint', label: '고민/증상', keywords: ['고민', '걱정', '신경', '불편', '거슬리', '싫어', '콤플렉스', '개선하고', '없애고'], group: '상담 목적' },
  { id: 'desired', label: '희망시술', keywords: ['받고 싶', '하고 싶', '맞고 싶', '관심', '알아보고', '해보고', '하러 왔', '맞으러', '하려고'], group: '상담 목적' },
  { id: 'budget', label: '예산', keywords: ['예산', '가격대', '얼마까지', '부담', '비용', '범위', '저렴', '합리적', '가성비'], group: '상담 목적' },
  { id: 'event', label: '앞둔 이벤트', keywords: ['결혼', '촬영', '여행', '면접', '행사', '동창회', '방송', '출연', '졸업', '입학', '데이트', '급해', '언제까지', '빨리'], group: '상담 목적' },
  { id: 'referral', label: '내원경로', keywords: [
    '어떻게 오셨', '어디서 보고', '알게 되',
    '간판', '지나가다', '워크인', '걸어',
    '카톡', '카카오', '문자', '메시지',
    '네이버', '블로그', '플레이스', '파워링크', '검색',
    '인스타', '인스타그램', '릴스', 'DM',
    '유튜브', '영상', '숏츠',
    '페이스북', '페북',
    '소개', '지인', '친구', '언니', '동생', '엄마', '추천받',
    '원래 다니던', '다른 지점', '타지점',
    '지하철', '버스', '광고', '전단지'
  ], group: '상담 목적' },
  // 의료 안전
  { id: 'allergy', label: '알레르기', keywords: ['알레르기', '알러지', '과민', '두드러기', '반응'], group: '의료 안전' },
  { id: 'medication', label: '복용약물', keywords: ['약', '복용', '아스피린', '혈전', '오메가', '한약', '영양제', '비타민', '드시는 약'], group: '의료 안전' },
  { id: 'disease', label: '기저질환', keywords: ['고혈압', '당뇨', '질환', '간', '갑상선', '심장', '아프신 데', '건강'], group: '의료 안전' },
  { id: 'pregnancy', label: '임신·수유', keywords: ['임신', '수유', '생리', '피임', '아기'], group: '의료 안전' },
  { id: 'special', label: '특이체질(켈로이드 등)', keywords: ['켈로이드', '흉터', '상처', '체질', '특이', '잘 안 낫', '오래 가'], group: '의료 안전' },
  { id: 'pain', label: '통증 민감도', keywords: ['아프', '통증', '무서워', '무섭', '겁나', '마취', '아플까', '참을 수', '예민'], group: '의료 안전' },
  // 이력
  { id: 'past_procedure', label: '시술이력', keywords: ['전에', '예전에', '저번에', '맞았', '했었', '받으신', '시술 받', '해봤', '다른 데서', '다른 병원'], group: '이력' },
  { id: 'past_sideeffect', label: '부작용이력', keywords: ['부작용', '문제', '부종', '괴사', '멍이', '부어', '아팠', '안 좋았', '만족 안'], group: '이력' },
];

// 안내사항 (상담사가 반드시 안내해야 할 항목)
const GUIDE_CHECKS = [
  // 부작용
  { id: 'minor_side', label: '가벼운 부작용', keywords: ['멍', '붓기', '발적', '열감', '뻣뻣', '당길 수', '약간', '일시적'], group: '부작용' },
  { id: 'serious_side', label: '심각한 부작용', keywords: ['괴사', '혈관폐색', '감염', '화상', '신경', '드물지만', '희박', '응급'], group: '부작용' },
  // 시술 정보
  { id: 'downtime', label: '다운타임', keywords: ['다운타임', '회복', '쉬어야', '며칠', '일주일', '세안', '화장', '운동', '사우나'], group: '시술 정보' },
  { id: 'duration', label: '시술유지기간', keywords: ['유지', '지속', '오래가', '효과가 나타', '몇 개월', '반년', '1년'], group: '시술 정보' },
  { id: 'cycle', label: '재시술 주기', keywords: ['주기', '간격', '다음에 오시', '후에 다시', '개월마다', '주마다', '다시 맞으', '터치업'], group: '시술 정보' },
  { id: 'sessions', label: '재시술 횟수', keywords: ['몇 번', '몇번', '횟수', '반복', '코스', '총 몇', '3회', '5회', '10회', '번 정도'], group: '시술 정보' },
  // 가격
  { id: 'price', label: '가격안내', keywords: ['가격', '비용', '얼마', '만원', '할인', '이벤트', '첫방문', '가격표'], group: '가격' },
  { id: 'package', label: '다회권/회원권', keywords: ['다회권', '회원권', '패키지', '프로그램', '묶음', '세트', '10회권', '5회권', '코스', '등록', '결제'], group: '가격' },
  // 영업
  { id: 'upsell', label: '업셀링', keywords: ['업그레이드', '더 좋은', '프리미엄', '고급', '추가하시면', '효과를 높이', '한단계 위', '좋은 제품'], group: '영업' },
  { id: 'crosssell', label: '크로스셀링', keywords: ['같이 하시면', '함께 하시면', '시너지', '콤보', '병행', '세트로', '추천드리는', '같이 받으시면', '효과가 배로'], group: '영업' },
];
